...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const embed = new EmbedBuilder()
      .setAuthor({ name: `${interaction.guild.members.me.displayName} Satus Info!`, iconURL: interaction.guild.iconURL({ dynamic: true })})
      .addFields([
        ...
        { name: '**RAM**', value: `\`\`\`RAM Used: ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} / ${( os.totalmem() / 1024 / 1024).toFixed(2)} MB\`\`\``, inline: false },
