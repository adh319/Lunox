  ...
  run: async (client, interaction) => {
    ...
    if (loadType === 'PLAYLIST_LOADED') {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`**Added: ${playlistInfo.name}** • \`${tracks.length}\` tracks • ${track.info.requester}`);
      ...
      const embed = new EmbedBuilder()
        .setColor(client.color)
        .setDescription(`**Added: ${track.info.title}** • \`${formatDuration(track.info.length)}\` • ${track.info.requester}`);
