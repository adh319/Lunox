...
module.exports = {
	...
	// PORU DETAILS
	playSource: process.env.PLAY_SOURCE || "spotify", // default search engine & "ytmsearch" / "spotify" / "deezer" / "apple"
	poruOptions: {
		defaultPlatform: process.env.DEFAULT_SOURCE || "ytmsearch", // "ytserach" / "ytmsearch" / "ytsearch" / "scsearch" / "spsearch"
