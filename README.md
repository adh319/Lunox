...
3. Fill required values in `.env` (`TOKEN`, `MONGO_URI`, Lavalink connection values).
...
> Notes:
>
> - Spotify/Apple/Deezer support depends on your Lavalink plugins and Lavalink server configuration.
